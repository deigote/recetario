...
La receta reproduce los ingredientes identificados en la captura; confirmar la tableta de praliné y el modelo/capacidad de CREAMi cuando el usuario responda. No equiparar cuatro raciones con cuatro tarros, ni masa con volumen. Respetar siempre MAX FILL y repartir sobrante si es necesario. `nutritionTargets: {perServing: null}` evita heredar el objetivo de 600 kcal de las comidas.
