...
Ordena siempre `ingredients` por su primera utilización en los pasos de preparación, también al modificar recetas existentes. Si varios se añaden juntos, sigue el orden en que aparecen en el paso; los ingredientes que se añaden al servir van al final. Cuando haya alternativas, sigue el método habitual del usuario y conserva la alternativa en la nota. Este orden se guarda directamente en el JSON; no hace falta ordenación automática en la interfaz. No repitas ingredientes: guarda el total en una sola entrada y explica su reparto en los pasos.
...
Las cantidades y gramos desconocidos son `null`, nunca cero. `per100g` permanece null hasta incorporar una etiqueta o fuente verificada. Los ingredientes con masa y los cuatro valores nutricionales se suman. Si faltan datos, se muestra un subtotal claramente marcado como parcial, con los nombres de los ingredientes excluidos. Si no hay ningún ingrediente completo, no se muestran cifras. Nunca se presenta un subtotal como el total completo. Excepción explícita: un ingrediente al gusto cuyo aporte el usuario considere despreciable puede llevar `negligibleNutrition: true`; se omite del cálculo y de los avisos de datos pendientes, sin inventar cantidades ni macros cero. La energía se suma desde el dato kcal; no se deduce de los macros redondeados. El total escala con las raciones y los valores por ración permanecen constantes. Los valores calculados son estimaciones según ingredientes y cantidades; documenta grasa descartada o porción comestible si corresponde.
...
En los pasos, las cantidades explícitas por ración pueden usar `{{food_id}}` (por ejemplo `{{honey}} g de miel`) para reflejar los ajustes. Mantén las unidades y la expresión «por ración» en el texto; los tiempos no se escalan. Evita cantidades fijas en las notas que contradigan los ajustes. Para cantidades del lote en los pasos, usa `{{batch:food_id}}`; admite una fracción, por ejemplo `{{batch:oil:8/15}}`. Las fracciones se aplican a la cantidad actual editada y a las raciones seleccionadas; los tokens antiguos sin `batch:` siguen indicando cantidades por ración.
...
Fuentes en foods: patata y leche entera FEN por 100 g; cebolla blanca FEN como aproximación a morada. El usuario confirma las verduras pesadas ya peladas: todos los pesos son los que entraron en la cazuela. Caldo pesado: referencia Gallina Blanca con aproximación de 1 g/ml en broth_weighed, sin alterar el caldo en ml del udon. Curry, ajo y sal al gusto con cantidad y nutrición null y negligibleNutrition: true, omitidos del cálculo y de avisos por petición expresa del usuario. Se conserva la documentación nutricional en preparationNotes, sin mostrar el párrafo de estimaciones en la ficha.

La alternativa aportada por el usuario es 30–35 g de nata ~18 % MG en lugar de 100 g de leche por lote: se guarda como proporción del 30–35 % para escalar, sin sumar ambas opciones. Macros calculados con leche. No se inventan tiempos de cocción. El peso de 700–800 g por ración es orientativo para el lote original y depende de evaporación; pesar el resultado para repartir.

Gelatina confirmada: INKAFOODS bovina 200 Bloom, ASIN B07PN64WRC. Etiqueta fotografiada en https://www.amazon.es/dp/B07PN64WRC : por 100 g, 340 kcal, 85 g proteína, 0 g hidratos y 0 g grasa. Consultada el 2026-09-21. Se aplica la hidratación en frío de al menos 30 minutos del envase al caldo indicado por el usuario. Subtotal por ración con leche y 15 g de aceite por lote: 701,7375 kcal, 60,975 g proteína, 67,7875 g hidratos y 18,00875 g grasa; especias sin pesar excluidas.
...
Método del usuario: arroz con unos 125 g de caldo para los 110 g secos del lote, 4 minutos a presión alta y hasta 10 de despresurización natural sin abrir la válvula; abrir solo una vez sin presión. No escalar tiempos ni vincular automáticamente arroz/caldo al editar. Mientras, pollo a fuego fuerte con tapa; retirar, añadir aceite y salteado, colocar pollo encima y tapar. Cuando empieza a agarrarse, retirar el pollo, añadir soja y remover. Momento propuesto para ajo/especias: con la soja al final. Sin notas nutricionales redundantes en la ficha.
