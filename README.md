...
Caldo dividido en dos entradas: 500 g para hidratar gelatina/cocer y 50 g fríos para la maicena, sin duplicar los 550 g totales. Aceite en dos entradas: 8 g para pollo y 7 g para cebolla. La lista decía 15 g y los pasos 8 + 5 g; se prioriza provisionalmente el total de la lista, pendiente de aclaración. Los pasos remiten a cada parte sin cantidades fijas que contradigan el selector. No usar tokens por food_id para ingredientes repetidos, pues devolverían solo la primera entrada.

Fuentes en foods: patata y leche entera FEN por 100 g; cebolla blanca FEN como aproximación a morada. Verduras consideradas peladas. Caldo pesado: referencia Gallina Blanca del catálogo con aproximación explícita de 1 g/ml en broth_weighed, sin alterar el caldo en ml del udon. Curry, ajo y sal agrupados al gusto con cantidad y nutrición null; excluidos del subtotal, no contabilizados como cero.
