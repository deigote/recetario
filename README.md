...
Propuesta de colágeno PENDIENTE de elección del usuario, no aplicada a la receta: cambiar 350 ml de Suprema semidesnatada por igual volumen de Suprema desnatada y añadir 10 g de colágeno HSN al lote, manteniendo skyr y los demás ingredientes. La leche ahorra 45,5 kcal; el colágeno estimado añade 40 kcal. Resultado calculado por ración, incluyendo la actualización de eritritol: 167,075 kcal, 10,94625 P, 21,71625 H (5 g de polialcoholes) y 5,78625 G. Son 2,5 g de colágeno por ración. Si se acepta, añadirlo después del chocolate, sin calor, mezclando hasta integrar, y ajustar el orden de ingredientes. La textura con menos grasa queda por probar. La proteína del colágeno se contabiliza, sin equipararla nutricionalmente a la proteína láctea. `suprema_skim` está disponible en el catálogo para esta propuesta.
...
Nutrición actual del helado por ración: 168,45 kcal, 8,44625 P, 21,71625 H incluyendo 5 g de polialcoholes (16,71625 H excluyéndolos), 7,09875 G. Se mantienen intactos los valores históricos de MFP. La propuesta de colágeno sigue pendiente, sin aplicarse. Con eritritol se propone LITE ICE CREAM / Helado light, de acuerdo con la recomendación de Ninja para recetas con edulcorantes: https://ninjakitchenapac.zendesk.com/hc/en-au/articles/5369888572303-Product-Setup-How-to-Use .
